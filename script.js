...
const communityClubsData = {
    ...
    '20-29': [
        ['Buona Vista CC', '36, HOLLAND DRIVE', '#01-01', '270036', {storybooks: true, textbooks: true}],
    ...
    '30-39': [
        ...
        ['Kallang CC', '45, BOON KENG ROAD', '', '339771', {storybooks: true, textbooks: true}],
        ['Kolam Ayer CC', '1, GEYLANG BAHRU LANE', '#01-01', '339631', {storybooks: true, textbooks: true}],
        ...
        ['Toa Payoh East CC', '160, LOR 6 TOA PAYOH', '', '319380', {storybooks: true, textbooks: true}],
    ...
    '40-49': [
        ['Bedok CC', '850, NEW UPPER CHANGI ROAD', '', '467352', {storybooks: true, textbooks: true}],
        ...
        ['Geylang Serai CC', '1, ENGKU AMAN TURN', '#01-01', '408528', {storybooks: true, textbooks: true}],
        ['Heartbeat@Bedok', '11, Bedok North Street 1', '#02-04', '469662', {storybooks: true, textbooks: true}],
        ['Joo Chiat CC', '405, JOO CHIAT ROAD', '#1-1', '427633', {storybooks: true, textbooks: true}],
        ...
        ['PAssion WaVe @ Marina Bay', '11, RHU CROSS', '#01-01', '437440', {storybooks: true, textbooks: true}],
    ...
    '50-59': [
        ['Aljunied CC', '110, HOUGANG AVE 1', '#01-1048', '530110', {storybooks: true, textbooks: true}],
        ...
        ['Braddell Heights CC', '242, SERANGOON AVENUE 3', '#01-198', '550242', {storybooks: true, textbooks: true}],
        ...
        ['Changi Simei CC', '10, SIMEI STREET 2', '', '529915', {storybooks: true, textbooks: true}],
        ...
        ['Our Tampines Hub', '1, TAMPINES WALK', '#04-01', '528523', {storybooks: true, textbooks: true}],
        ['Pasir Ris Central CC', '536, Pasir Ris Drive 1', '#01-286', '510536', {storybooks: true, textbooks: true}],
        ['Pasir Ris East CC', '1, PASIR RIS DRIVE 4', '#01-08', '519457', {storybooks: true, textbooks: true}],
        ...
        ['Punggol CC', '3, HOUGANG AVE 6', '', '538808', {storybooks: true, textbooks: true}],
        ['Rivervale CC', '2, RIVERVALE CLOSE', '#01-01', '544583', {storybooks: true, textbooks: true}],
        ...
        ['The Serangoon CC', '10, SERANGOON NORTH AVE 2', '', '555877', {storybooks: true, textbooks: true}],
    ...
    '60-69': [
        ...
        ['Gek Poh Ville CC', '1, Jurong West Street 74', '', '649149', {storybooks: true, textbooks: true}],
        ...
        ['Senja-Cashew CC', '101, BUKIT PANJANG ROAD', '#01-1', '679910', {storybooks: true, textbooks: true}],
        ...
        ['Zhenghua CC', '640A, SENJA CLOSE', '#01-301', '671640', {storybooks: true, textbooks: true}]
    ],
    '70-79': [
        ['ACE The Place CC', '120, WOODLANDS AVENUE 1', '', '739069', {storybooks: true, textbooks: true}],
        ...
        ['PAssion WaVe @ Sembawang', '60, JALAN MEMPURONG', '', '759058', {storybooks: true, textbooks: true}],
